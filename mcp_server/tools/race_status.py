...
async def get_starting_grid(car_number: Optional[str] = Field(default=None, description="Car number")) -> Dict[str, Any]:
...
async def get_track_info(car_number: str = Field(description="Car number")) -> Dict[str, Any]:
